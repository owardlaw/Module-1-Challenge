...
loans_length = len(loan_costs)
print(f"Amount of loans is {loans_length}.")
...
print(f"Total loan amount is ${loans_sum}.")
...
loans_avgerage = loans_sum/loans_length
print(f"Avgerage loan amount is ${loans_avgerage}.")
...
fair_value = present_value * (1 + 0.2) ** 9
...
print(f"Present value is ${round(present_value, 2)} and fair value is ${fair_value}.")
...
def npv_loan(loan_price, remaining_months, annual_discount_rate, future_value):

    present_value = future_value / (1 + (annual_discount_rate / 12)) ** remaining_months

    net_present_value = present_value - loan_price
...
npv = npv_loan(
    loan_price=800, remaining_months=12, annual_discount_rate=0.2, future_value=1000
)
print(f"The present value of the loan is: ${round(npv, 2)}")
